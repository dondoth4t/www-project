            ...
            <div class="card-body p-4">
                ...
                <form action="login.php" method="post">
                    <div class="mb-3">
                        ...
                        <input type="email" name="sign-up-email" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Password</label>
                        <input type="password" name="sign-up-password" class="form-control">
                    </div>
                    <div class="mb-3">
                        <button type="submit" name="sign-up" class="btn btn-primary">Sign Up</button>
                    </div>
                    <div>
                        <a class="form-text" href="/comp3340/project/login.php">Have an account? Click here to log in.</a>
                    </div>
                </form>
            </div>
        </div>
